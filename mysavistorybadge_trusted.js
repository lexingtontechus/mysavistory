MakerBadge.prototype = {
  ...
  run: function (callback) {
    ...
    var img = 'https://www.savivets.org/wp-content/uploads/2019/03/Trusted-Partner.png'
    var border = '';
    if(that.theme=='dark'){
      //img = 'https://tinify-bucket.s3-us-west-1.amazonaws.com/blm-blue-round.png'
      img = 'https://www.savivets.org/wp-content/uploads/2019/03/Trusted-Partner.png'
    }
